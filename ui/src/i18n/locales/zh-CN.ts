...
export const zh_CN: TranslationMap = {
  common: {
    ...
    errors: {
      ...
      noReason: "无原因",
      eventGapDetected: "检测到事件序号缺口（期望 {expected}，实际 {received}）；建议刷新",
      requestFailed: "请求失败",
      gatewayNotConnected: "网关未连接",
      gatewayClientStopped: "网关客户端已停止",
      connectFailed: "连接失败",
      authTokenMismatch: "未授权：网关令牌不匹配（请使用当前令牌重新打开仪表盘 URL）",
      authRateLimited: "未授权：认证失败次数过多（请稍后重试）",
      authUnauthorized: "未授权：认证失败",
      chatError: "聊天出错",
    },
  },
  nav: {
  ...
  channels: {
    ...
    nostrProfile: {
      ...
      bioHelp: "简短的个人简介或描述",
      avatarUrl: "头像 URL",
      avatarUrlHelp: "你的资料图片 HTTPS URL",
      advanced: "高级",
      bannerUrl: "横幅 URL",
      ...
      lightningAddressHelp: "用于接收打赏的闪电地址（LUD-16）",
      saving: "保存中...",
      savePublish: "保存并发布",
      importing: "导入中...",
      importRelays: "从中继导入",
      ...
      publishFailedAllRelays: "资料发布到所有中继都失败了。",
      publishedToRelays: "资料已发布到中继。",
      updateFailedWithError: "资料更新失败：{error}",
      importFailedStatus: "资料导入失败（{status}）",
      importedFromRelaysReviewPublish: "已从中继导入资料。请检查后再发布。",
      importedReviewPublish: "资料已导入。请检查后再发布。",
      importFailedWithError: "资料导入失败：{error}",
    },
    status: {
      running: "运行中",
      configured: "已配置",
    ...
    config: {
      schemaUnavailable: "配置结构不可用。请使用原始模式。",
      channelSchemaUnavailable: "频道配置结构不可用。",
      loadingSchema: "正在加载配置结构…",
      saving: "保存中…",
    },
  },
  execApproval: {
    title: "需要执行审批",
    expiresIn: "将在 {value} 后过期",
    expired: "已过期",
    pending: "{count} 个待处理",
    host: "主机",
    agent: "代理",
  ...
  settings: {
    ...
    form: {
      ...
      unsafeFields: "表单视图无法安全编辑部分字段。请使用原始模式，避免丢失配置项。",
      rawJson5: "原始 JSON5",
      schemaUnavailable: "结构不可用。",
      unsupportedSchema: "不支持的结构。请使用原始模式。",
      noMatch: "没有设置匹配“{query}”",
      noSection: "此分区没有设置",
      unsupportedSchemaNode: "不支持的结构节点。请使用原始模式。",
      unsupportedType: "不支持的类型：{type}。请使用原始模式。",
      defaultValue: "默认：{value}",
      resetToDefault: "重置为默认值",
      select: "请选择...",
      unsupportedArraySchema: "不支持的数组结构。请使用原始模式。",
      oneItem: "1 项",
      itemsCount: "{count} 项",
      add: "添加",
      emptyArray: "还没有项目。点击“添加”创建。",
      removeItem: "移除项目",
      customEntries: "自定义条目",
      addEntry: "添加条目",
  ...
  agents: {
    ...
    skills: {
      title: "技能",
      subtitle: "按代理设置的技能允许列表与工作区技能。",
      useAll: "全部使用",
      disableAll: "全部禁用",
      loadConfigHint: "加载网关配置以设置代理技能。",
      customAllowlistHint: "该代理正在使用自定义技能允许列表。",
      allEnabledHint: "当前已启用全部技能。禁用任一技能后会创建代理级允许列表。",
  ...
  cron: {
    ...
    form: {
      ...
      sessionKey: "会话键",
      sessionKeyHelp: "用于任务投递和唤醒路由的可选路由键。",
      accountId: "账号 ID",
      accountIdPlaceholder: "默认",
      accountIdHelp: "多账号场景下可选的频道账号 ID。",
      lightContext: "轻量上下文",
      lightContextHelp: "为此代理任务使用轻量引导上下文。",
      failureAlerts: "失败告警",
      failureAlertsInherit: "继承全局设置",
      failureAlertsDisabled: "仅对此任务禁用",
      failureAlertsCustom: "自定义任务级设置",
      failureAlertsHelp: "控制此任务发送重复失败告警的时机。",
      failureAlertAfter: "达到多少次后告警",
      failureAlertAfterHelp: "连续出错多少次后开始告警。",
      failureAlertCooldown: "冷却时间（秒）",
      failureAlertCooldownHelp: "两次告警之间的最小秒数。",
      failureAlertChannel: "告警频道",
      failureAlertTo: "告警收件人",
      failureAlertToHelp: "失败告警的可选收件人覆盖。",
      failureAlertMode: "告警模式",
      failureAlertModeAnnounce: "发布（通过频道）",
