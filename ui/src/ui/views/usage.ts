...
export function renderUsage(props: UsageProps) {
        ...
        <div class="row" style="justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 12px;">
          <div style="flex: 1; min-width: 250px;">
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 2px;">
              <div class="card-title" style="margin: 0;">${t("usage.loading.title")}</div>
              <span style="
                display: inline-flex;
                align-items: center;
                gap: 6px;
          ...
          <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 8px;">
            <div style="display: flex; gap: 8px; align-items: center;">
              ...
              <span style="color: var(--muted);">${t("usage.common.to")}</span>
  ...
  const displaySessionLabel =
    displaySessionCount === 1 ? t("usage.common.session") : t("usage.common.sessions");
  ...
  const datePresets = [
    ...
    { label: t("usage.presets.sevenDays"), days: 7 },
    { label: t("usage.presets.thirtyDays"), days: 30 },
  ];
        ...
        <summary>
          ...
          ${
            selectedCount > 0
              ...
              : html`
                  <span class="usage-filter-badge">${t("usage.common.all")}</span>
                `
          }
        </summary>
    ...
    <section class="card usage-header ${props.headerPinned ? "pinned" : ""}">
      <div class="usage-header-row">
        <div class="usage-header-title">
          ...
          ${
            isEmpty
              ? html`
                  <span class="usage-query-hint">${t("usage.filters.emptyHint")}</span>
                `
              : nothing
          }
        </div>
        <div class="usage-header-metrics">
            ...
            displayTotals
              ? html`
                <span class="usage-metric-badge">
                  <strong>${formatTokens(displayTotals.totalTokens)}</strong> ${t("usage.common.tokens")}
                </span>
                <span class="usage-metric-badge">
                  <strong>${formatCost(displayTotals.totalCost)}</strong> ${t("usage.common.cost")}
                </span>
                <span class="usage-metric-badge">
          ...
          <button
            ...
            title=${props.headerPinned ? t("usage.header.unpinTitle") : t("usage.header.pinTitle")}
            @click=${props.onToggleHeaderPinned}
          >
            ${props.headerPinned ? t("usage.header.pinned") : t("usage.header.pin")}
          </button>
          <details
          ...
          >
            <summary class="usage-export-button">${t("usage.header.export")}</summary>
      ...
      <div class="usage-header-row">
        <div class="usage-controls">
          ...
          >
            <option value="local">${t("usage.common.local")}</option>
          ...
          <div class="chart-toggle">
            ...
            >
              ${t("usage.filters.tokensMode")}
            </button>
            <button
              class="toggle-btn ${!isTokenMode ? "active" : ""}"
              @click=${() => props.onChartModeChange("cost")}
            >
              ${t("usage.filters.costMode")}
            </button>
          </div>
          <button
      ...
      <div style="margin-top: 12px;">
          ...
          <input
            ...
            placeholder=${t("usage.filters.placeholder")}
          ...
          <div class="usage-query-actions">
            ...
            ${
              hasDraftQuery || hasQuery
                ? html`<button class="btn btn-sm usage-action-btn usage-secondary-btn" @click=${props.onClearQuery}>${t("usage.common.clear")}</button>`
                : nothing
            }
            <span class="usage-query-hint">
              ${
                hasQuery
                  ? t("usage.filters.matchCount", {
                      matched: String(filteredSessions.length),
                      total: String(totalSessions),
                    })
                  : t("usage.filters.rangeCount", { total: String(totalSessions) })
              }
            </span>
          </div>
        </div>
        ...
        props.sessionsLimitReached
          ? html`
              <div class="callout warning" style="margin-top: 12px">
                ${t("usage.warnings.sessionsLimit")}
              </div>
            `
          : nothing
      }
