...
const SECURITY_OPTIONS: Array<{ value: ExecSecurity; labelKey: string }> = [
  { value: "deny", labelKey: "nodes.approvals.securityOptions.deny" },
  { value: "allowlist", labelKey: "nodes.approvals.securityOptions.allowlist" },
  { value: "full", labelKey: "nodes.approvals.securityOptions.full" },
];

const ASK_OPTIONS: Array<{ value: ExecAsk; labelKey: string }> = [
  { value: "off", labelKey: "nodes.approvals.askOptions.off" },
  { value: "on-miss", labelKey: "nodes.approvals.askOptions.onMiss" },
  { value: "always", labelKey: "nodes.approvals.askOptions.always" },
];

function securityOptionLabel(value: ExecSecurity) {
  return t(`nodes.approvals.securityOptions.${value}`);
}

function askOptionLabel(value: ExecAsk) {
  return value === "on-miss"
    ? t("nodes.approvals.askOptions.onMiss")
    : t(`nodes.approvals.askOptions.${value}`);
}
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
          ...
          <div class="card-sub">
            ${t("nodes.approvals.subtitle")} <span class="mono">exec host=gateway/node</span>.
          </div>
        </div>
        <button
          class="btn"
    ...
    <div class="list" style="margin-top: 12px;">
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${t("nodes.approvals.targetSubtitle")}
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
            ...
            >
              ...
              <option value="node" ?selected=${state.target === "node"}>${t("nodes.approvals.node")}</option>
            </select>
          </label>
          ${
            state.target === "node"
              ? html`
                <label class="field">
                  <span>${t("nodes.approvals.node")}</span>
                  <select
      ...
      ${
        state.target === "node" && !hasNodes
          ? html`
              <div class="muted">${t("nodes.approvals.noNodeTargets")}</div>
            `
          : nothing
      }
    </div>
    ...
    <div class="list" style="margin-top: 16px;">
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${isDefaults ? t("nodes.approvals.securitySubtitle") : t("nodes.approvals.defaultValue", { value: securityOptionLabel(defaults.security) })}
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
              ...
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${securityValue === "__default__"}>
                    ${t("nodes.approvals.useDefaultWithValue", { value: securityOptionLabel(defaults.security) })}
                  </option>`
                  : nothing
              }
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${isDefaults ? t("nodes.approvals.askSubtitle") : t("nodes.approvals.defaultValue", { value: askOptionLabel(defaults.ask) })}
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
              ...
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${askValue === "__default__"}>
                    ${t("nodes.approvals.useDefaultWithValue", { value: askOptionLabel(defaults.ask) })}
                  </option>`
                  : nothing
              }
              ${ASK_OPTIONS.map(
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${
              isDefaults
                ? t("nodes.approvals.askFallbackSubtitle")
                : t("nodes.approvals.defaultValue", {
                    value: securityOptionLabel(defaults.askFallback),
                  })
            }
          </div>
        </div>
              ...
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${askFallbackValue === "__default__"}>
                    ${t("nodes.approvals.useDefaultWithValue", { value: securityOptionLabel(defaults.askFallback) })}
                  </option>`
                  : nothing
              }
              ${SECURITY_OPTIONS.map(
      ...
      <div class="list-item">
        <div class="list-main">
          <div class="list-title">${t("nodes.approvals.autoAllowSkills")}</div>
          <div class="list-sub">
            ${
              isDefaults
                ? t("nodes.approvals.autoAllowSkillsSubtitle")
                : autoIsDefault
                  ? t("nodes.approvals.usingDefault", {
                      value: onOffLabel(defaults.autoAllowSkills),
                    })
                  : t("nodes.approvals.overrideValue", { value: onOffLabel(autoEffective) })
            }
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
            <span>${t("nodes.approvals.enabled")}</span>
            <input
              type="checkbox"
              ?disabled=${state.disabled}
...
function renderExecApprovalsAllowlist(state: ExecApprovalsState) {
  ...
  return html`
    <div class="row" style="margin-top: 18px; justify-content: space-between;">
      <div>
        <div class="card-title">${t("nodes.approvals.allowlist")}</div>
    ...
    <div class="list" style="margin-top: 12px;">
      ${
        entries.length === 0
          ? html`
              <div class="muted">${t("nodes.approvals.noAllowlist")}</div>
            `
