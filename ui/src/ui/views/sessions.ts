...
const VERBOSE_LEVELS = [
  ...
  { value: "off", labelKey: "sessions.options.offExplicit" },
  { value: "on", labelKey: "common.on" },
  { value: "full", labelKey: "sessions.options.full" },
] as const;
const FAST_LEVELS = [
  { value: "", labelKey: "common.inherit" },
  { value: "on", labelKey: "common.on" },
...
function withCurrentLabeledOption(
  ...
  if (translated.some((option) => option.value === current)) {
    return translated;
  }
  return [
    ...translated,
    { value: current, label: t("sessions.options.custom", { value: current }) },
  ];
}
    ...
    <section class="card">
      ...
      <div class="table" style="margin-top: 16px;">
        <div class="table-head">
          ...
          <div>${t("sessions.columns.fast")}</div>
